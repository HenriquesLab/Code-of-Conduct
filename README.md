...
- **Funding**: Lab members should apply for funding to attend conferences. If funding is not available, they should discuss with their supervisor(s) whether the lab can cover the costs. Decisions are done on a case-by-case basis but are generally more favorable to members presenting their work or junior researchers attending courses or workshops.
